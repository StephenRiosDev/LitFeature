 ...
 * @class LitCore
 * @extends {LitElement}
 * @description Base class for web components with feature management capabilities.
...
export class LitCore extends LitElement {
  ...
  /**
   * @static
   * @param {string} componentName - The custom element name to register (e.g., 'my-button')
